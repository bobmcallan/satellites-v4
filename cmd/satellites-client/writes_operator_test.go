...
var writesOperatorHappy = []struct {
	...
	{"project add", []string{"project", "add", "--name", "proj"}, "project_add", map[string]any{"id": "proj_x"}},
	...
	{"workspace add", []string{"workspace", "add", "--name", "w"}, "workspace_add", map[string]any{"id": "wksp_x"}},
...
var writesOperatorMissingFlag = []struct {
	...
	{"project add no name", []string{"project", "add"}},
	{"workspace add no name", []string{"workspace", "add"}},
