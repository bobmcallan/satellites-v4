...
var writesOperatorHappy = []struct {
	...
	{"agent create", []string{"agent", "create", "--scope", "system", "--name", "a"}, "agent_create", map[string]any{"id": "doc_a"}},
	...
	{"contract create", []string{"contract", "create", "--scope", "system", "--name", "c"}, "contract_create", map[string]any{"id": "doc_c"}},
	...
	{"principle create", []string{"principle", "create", "--scope", "system", "--name", "p"}, "principle_create", map[string]any{"id": "doc_p"}},
	...
	{"reviewer create", []string{"reviewer", "create", "--scope", "system", "--name", "r"}, "reviewer_create", map[string]any{"id": "doc_r"}},
	...
	{"role create", []string{"role", "create", "--scope", "system", "--name", "ro"}, "role_create", map[string]any{"id": "doc_ro"}},
	...
	{"skill create", []string{"skill", "create", "--scope", "system", "--name", "s"}, "skill_create", map[string]any{"id": "doc_s"}},
