...
func (a *APIRegistrar) registerOperatorWriteRoutes(mux *http.ServeMux) {
	a.handle(mux, "POST /api/v1/story/add", a.handleStoryAdd)
	a.handle(mux, "POST /api/v1/story/update", a.handleStoryUpdate)
	a.handle(mux, "POST /api/v1/story/delete", a.handleStoryDelete)
	a.handle(mux, "POST /api/v1/story/close", a.handleStoryClose)

	a.handle(mux, "POST /api/v1/project/add", a.handleProjectAdd)
	a.handle(mux, "POST /api/v1/project/update", a.handleProjectUpdate)
	a.handle(mux, "POST /api/v1/project/delete", a.handleProjectDelete)

	a.handle(mux, "POST /api/v1/workspace/add", a.handleWorkspaceAdd)
	a.handle(mux, "POST /api/v1/workspace/member-add", a.handleWorkspaceMemberAdd)
	a.handle(mux, "POST /api/v1/workspace/member-update-role", a.handleWorkspaceMemberUpdateRole)
	a.handle(mux, "POST /api/v1/workspace/member-remove", a.handleWorkspaceMemberRemove)

	a.handle(mux, "POST /api/v1/kv/set", a.handleKVSet)
	a.handle(mux, "POST /api/v1/kv/delete", a.handleKVDelete)

	a.handle(mux, "POST /api/v1/changelog/add", a.handleChangelogAdd)
	a.handle(mux, "POST /api/v1/changelog/update", a.handleChangelogUpdate)
	a.handle(mux, "POST /api/v1/changelog/delete", a.handleChangelogDelete)

	a.handle(mux, "POST /api/v1/repo/add", a.handleRepoAdd)

	a.handle(mux, "POST /api/v1/document/add", a.handleDocumentAdd)
	a.handle(mux, "POST /api/v1/document/update", a.handleDocumentUpdate)
	a.handle(mux, "POST /api/v1/document/delete", a.handleDocumentDelete)

	// Doc-family wrappers — same handlers with type pinned by the route.
	a.handle(mux, "POST /api/v1/agent/add", a.handleAgentAdd)
	a.handle(mux, "POST /api/v1/agent/update", a.handleAgentUpdate)
	a.handle(mux, "POST /api/v1/agent/delete", a.handleAgentDelete)
	a.handle(mux, "POST /api/v1/contract/add", a.handleContractAdd)
	a.handle(mux, "POST /api/v1/contract/update", a.handleContractUpdate)
	a.handle(mux, "POST /api/v1/contract/delete", a.handleContractDelete)
	a.handle(mux, "POST /api/v1/principle/add", a.handlePrincipleAdd)
	a.handle(mux, "POST /api/v1/principle/update", a.handlePrincipleUpdate)
	a.handle(mux, "POST /api/v1/principle/delete", a.handlePrincipleDelete)
	a.handle(mux, "POST /api/v1/reviewer/add", a.handleReviewerAdd)
	a.handle(mux, "POST /api/v1/reviewer/update", a.handleReviewerUpdate)
	a.handle(mux, "POST /api/v1/reviewer/delete", a.handleReviewerDelete)
	a.handle(mux, "POST /api/v1/role/add", a.handleRoleAdd)
	a.handle(mux, "POST /api/v1/role/update", a.handleRoleUpdate)
	a.handle(mux, "POST /api/v1/role/delete", a.handleRoleDelete)
	a.handle(mux, "POST /api/v1/skill/add", a.handleSkillAdd)
	a.handle(mux, "POST /api/v1/skill/update", a.handleSkillUpdate)
	a.handle(mux, "POST /api/v1/skill/delete", a.handleSkillDelete)
}
